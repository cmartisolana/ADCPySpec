...
def test_parseval_2d(rtol=1.e-14, debug=False):
    """ Make sure 2D spectrum satisfied Parseval relation """
    ...
    for dt in dta: 
        ...
        for n in N:
            ...
            phi = phi - phi.mean()
            spec_phi = spec.TWODimensional_spec(phi,dt,dt)
